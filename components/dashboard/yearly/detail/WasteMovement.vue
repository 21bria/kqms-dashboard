      ...
      <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div class="flex items-center justify-between mb-6">
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Waste Movement</h3>
...
const chartTitle = ref('Yearly trend waste')
...
async function fetchChartData() {
  try {
    ...
    const url = `${BASE_URL}dashboard/api/chart/detail-waste/?${params.toString()}`
