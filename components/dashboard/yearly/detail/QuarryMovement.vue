   ...
   <div class="space-y-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div class="flex items-center justify-between mb-6">
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Quarry Movement</h3>
...
const chartTitle = ref('Yearly trend Quarry')
...
async function fetchChartData() {
  try {
    ...
    params.append('filter_type', 'yearly') // sesuai komponen ini
    if (chartFilter.year) params.append('filter_year', chartFilter.year.toString())


    const url = `${BASE_URL}dashboard/api/chart/detail-quarry/?${params.toString()}`
